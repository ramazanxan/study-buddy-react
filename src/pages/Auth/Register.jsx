  ...
  return (
    <div className="auth-wrap">
      <form className="auth-card wide" onSubmit={submit}>
          ...
          <div className="reg-col">
            ...
            <div className="field">
              ...
              <input className={`input ${errors.login ? 'has-error' : ''}`} value={form.login}
                onChange={(e) => set('login', e.target.value.replace(/[^a-zA-Z0-9_]/g, ''))} placeholder="latin_only" />
        ...
        <Button type="submit" variant="primary" className="btn-block" loading={loading}>Зарегистрироваться</Button>
